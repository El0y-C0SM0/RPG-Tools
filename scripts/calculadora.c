...
void help() {
    ...
    puts("Como calcular:");
    puts("insira o numero, o operador e outro numero, caso queira outra operaço a partir do resultado da operação anterior é só digitar outro operador e outro valor. A operação incerra com o operador igual (=). As contas são realizadas na ordem das entradas\n");
